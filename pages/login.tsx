...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (formData.email === 'demo@ai-charya.com' && formData.password === 'demo123') {
      ...
      setTimeout(() => {
        setError('Invalid credentials. Try demo@ai-charya.com / demo123');
        setLoading(false);
      }, 1000);
    }
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/50 rounded-lg p-3 text-cyan-400 text-sm">
              <strong>Demo Credentials:</strong><br />
              Email: demo@ai-charya.com<br />
              Password: demo123
            </div>
